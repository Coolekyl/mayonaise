...
class CartController extends AbstractController
{
    ...
    public function indexAction()
    {
        ...
        if ($cart != '') {
            ...
            if (isset($cart)) {
                ...
                $product = $em->getRepository('App:Product')->findAll();
            } else {
    ...
    {
        // verwerken van invoiceLines in de nieuwe invoice voor de huidige klant.
        $session = $this->get('request_stack')->getCurrentRequest()->getSession();
        // $cart = $session->set('cart', '');
        $cart = $session->get('cart', array());

        // aanmaken invoice invoiceLine.
        $em = $this->getDoctrine()->getManager();
        ...
        //var_dump($cart);
        // vullen invoiceLines met orderinvoiceLines.
        ...
        if (isset($cart)) {
            ...
            foreach ($cart as $id => $quantity) {
                ...
                $invoiceLine->setAmount($quantity);
                $invoiceLine->setProductId($product);
